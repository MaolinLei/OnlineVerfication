...
int main(int argc, char **argv)
{
    ...
    // kdl_parser::treeFromFile("/home/oem/catkin_ws/src/ModularBot_B_experiment/urdf/ModularBot.urdf",my_tree);
    double dt;
    dt = 0.01;
    ros::Rate rate(1./dt);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    Object_Position(0) = -0.05; 
    Object_Position(1) = -0.6 ;
    Object_Position(2) = 0.153;
...
for(int repeat=0;repeat<=1;repeat++)
{
   ...
   for(int task=0;task<=3;task++)
   {
    ...
    if(task==0)
    {
    roatation_x = -1.0 * M_PI;
    roatation_y = -0.05 * M_PI;
    roatation_z = -0.4 * M_PI;
    ...
    Rotation_desire_3d = yawAngle * pitchAngle * rollAngle;
   ...
   // p[1] = cartpos.p(1);
    ...
    pos_des[2] = Object_Position(2)+0.05;
   ...
   */
     ...
     else if(task==2)
   {
    ...
    // Rotation_desire = Rotation_op_init;
     ...
     if(fabs(Error_(0))>=fabs(Error_(1)) && fabs(Error_(0))>=fabs(Error_(2)) && pp/10 ==0)
     {
     Slack_Vector(0) = 1;
     Slack_Vector(1) = 0;
     Slack_Vector(2) = 0;
     ...
     else if(fabs(Error_(1))>=fabs(Error_(0)) && fabs(Error_(1))>=fabs(Error_(2)) && pp/10 ==0)
     {
     Slack_Vector(0) = 0;
     Slack_Vector(1) = 1;
     Slack_Vector(2) = 0;
     ...
     else if(fabs(Error_(2))>=fabs(Error_(0)) && fabs(Error_(2))>=fabs(Error_(1)) && pp/10 ==0)
     {
     Slack_Vector(0) = 0;
     Slack_Vector(1) = 0;
     Slack_Vector(2) = 1;
