...
int main(int argc, char **argv)
{
    ...
    kdl_parser::treeFromFile("/home/oem/catkin_ws/src/ModularBot_5DOF_A/urdf/ModularBot.urdf",my_tree);
...
///////////////////////////////////////////////////////////////
    ...
    HierachySeq.open("/home/oem/catkin_ws/src/mpc/fcl_test/src/sources/HierachySeq.txt");
 ...
 */
    ...
    result_jointVel =  _velcity_FirstHierachy;
     ...
     if (HierachySeq.is_open()) {
        HierachySeq << Slack_Vector(0) <<"\t"<<  Slack_Vector(1) <<"\t" << Slack_Vector(2)
            <<"\t" << Slack_Vector(3)<<"\t" << Slack_Vector(4)<<"\t" << Slack_Vector(5)  <<std::endl;
    } 
